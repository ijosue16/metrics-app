...
# 📖 [Meteo forecast] <a name="about-project"></a>

> This is a website built using React and redux toolkit it showcases the weather information of certain city that are provided.
**[Meteo forecast]** This is a website built using React and redux toolkit it showcases the weather information of certain city that are provided.
...
```sh
  cd `<folder name>`
  git clone https://github.com/ijosue16/metrics-app.git
```
-
